...
def _fundamental():
    return FundamentalInsight(
        summary="Test", key_metrics={}, quant_metrics={}, business_moat="test",
        financial_resilience="test", growth_efficiency="test", bull_case="test",
        bear_case="test", sources=[], confidence=0.8, recommendation="buy"
    )

def _sentiment():
    return SentimentInsight(
        summary="Test", sentiment_score=0.5, key_catalysts=[], news_highlights=[],
        sources=[], confidence=0.8, recommendation="buy"
    )

def _valuation():
    return ValuationInsight(
        summary="Test", valuation_metrics={}, peer_comparison={}, price_targets={},
        sources=[], confidence=0.8, recommendation="buy"
    )

def _macro():
    return MacroInsight(
        summary="Test", interest_rate_impact="test", inflation_impact="test",
        sector_trend="test", macro_bull_case="test", macro_bear_case="test",
        confidence=0.8, recommendation="hold", sources=[]
    )
